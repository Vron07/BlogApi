...
# Below code is used for search filter

class PostListSelf(ListAPIView):
    queryset = Post.objects.all()
    serializer_class = PostSerializer
    permission_classes = [IsAuthenticated]

    filter_backends = [filters.SearchFilter]
    search_fields = ['user__username','postName']
...
class ReplyList(ListCreateAPIView):
  ...
  # Below code is used for search filter
  class ReplyListSelf(ListAPIView):
    queryset = Post.objects.all()
    serializer_class = PostSerializer
    permission_classes = [IsAuthenticated]

    filter_backends = [filters.SearchFilter]
    search_fields = ['comments__content','content']
